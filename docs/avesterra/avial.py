...
def create_entity(name, klass, subklass, auth, *, outlet=None, server=None,
                  autosave=True):
    """
    ...
    server : Entity, optional
        the server on which the new entity is to be created. If not provided,
        the new entity is created on the default server.

    autosave : bool, optional
        should every change to the entity be automatically saved by the outlet?
    ...
    ent = atapi.create(
        ...
        klass=klass, 
        subklass=subklass,
        server=TranslateFromAvialToAPI.entity(server))

    if outlet is not None:
        connect_method(ent, outlet, auth, handle_exceptions=False)
        invoke(
            ent, Method.CREATE, auth, name=name,
            parameter=Argument.AUTOSAVE if autosave else Argument.NULL)
    return ent 
    ...
    if (ignore_references or 
        ...
        with suppress_console_error_logging('Server reported ENTITY error'):
            with suppress_console_error_logging('Server reported OUTLET error'):
                try:
                    invoke(entity, Method.DELETE, auth)
...
def save_entity(entity, auth):
    ...
    >>> av.finalize()
    """ 
    invoke(entity, Method.SAVE, auth)
...
def restore_entity(entity, auth):
    ...
    >>> av.finalize()
    """ 
    invoke(entity, Method.LOAD, auth)
...
def erase_entity(entity, auth, *, attribute=None, instance=None):
    ...
    >>> av.finalize()
    """ 
    invoke(entity, Method.ERASE, auth, attribute=attribute, instance=instance)
...
def redirect_entity(simple_UUID, complex_UUID, auth):  
    ...
    """
    invoke(
        None, Method.AVESTERRA, auth, name='REDIRECT', key=simple_UUID, 
        value=complex_UUID)
...
def invoke_entity(entity, method, auth=None, *, attribute=None, instance=None, 
                  name=None, key=None, value=None, options=None, parameter=None,
                  index=None, count=None, mode=None, precedence=None, 
                  timeout=None, auxiliary=None):
    """
    invoke_entity(entity, method, auth=None, *, attribute=None, instance=None, name=None, key=None, value=None, options=None, parameter=None, index=None, count=None, mode=None, precedence=None, timeout=None, auxiliary=None)
    ...
    auth : Authorization or None, optional
        The object that authorizes the invocation of ``method``
    ...
    parameter : Argument or None, optional
        ...
        ``parameter`` of Argument.AUTOSAVE if the adapter is to automatically
    ...
    >>> av.invoke_entity(
    ...     jack, av.Method.SET, auth, attribute=av.Attribute.CHILD,
    ...     instance=3, index=2, value='Honey Hollman')
    b''
    ...
    >>> av.invoke_entity(
    ...     jack, av.Method.INSERT, auth, name='fan of', 
    ...     key='boyhood team', value='New York Yankees')
    b''
    ...
    """
    return invoke(
        entity, method, auth, attribute=attribute, instance=instance,
        name=name, key=key, value=value, options=options, parameter=parameter, 
        index=index, count=count, mode=mode, precedence=precedence, 
        timeout=timeout, auxiliary=auxiliary, return_results=True)

def invoke(entity, method, auth=None, attribute=None, instance=None, 
           name=None, key=None, value=None, options=None, parameter=None, 
           index=None, count=None, mode=None, precedence=None, timeout=None, 
           auxiliary=None, return_results=False, results_as_string=False):
...
def inquire_entity(entity, auth=None, *, attribute=None, instance=None, 
                   name=None, key=None, value=None, options=None, 
                   parameter=None, index=None, count=None, mode=None, 
                   timeout=None, auxiliary=None):
    """
    inquire_entity(entity, auth=None, *, attribute=None, instance=None, name=None, key=None, value=None, options=None, parameter=None, index=None, count=None, mode=None, timeout=None, auxiliary=None)
    ...
    auth : Authorization or None, optional
        An object that authorizes the inquiry
    ...
    parameter : Argument or None, optional
        An inquiry may make use of an Argument
...
def store_entity(entity, value, auth, *, mode=None):
    """
    store_entity(entity, value, auth, *, mode=None)
    ...
    AvialError
        ...
        ``auth`` does not authorize storing new content on the entity,
    ...
    try: 
        invoke(
            entity, Method.STORE, auth, value=value_obj, 
            mode=TranslateFromAvialToAPI.mode(mode))
...
def retrieve_entity(entity, auth=None):
    """
    retrieve_entity(entity, auth=None)
    ...
    auth: Authorization or None, optional
        An object that authorizes the retrieval.
    ...
    >>> av.finalize()
    """ 
    return _validate_and_simplify(_retrieve_raw(entity, auth))
...
def _retrieve_raw(entity, auth):
    """Retrieve content."""
    return invoke(entity, Method.RETRIEVE, auth, return_results=True)
...
def get_value(entity, auth=None, *, attribute=None, instance=None, index=None):
    """
    get_value(entity, auth=None, *, attribute=None, instance=None, index=None)
    ...
    auth: Authorization or None, optional
        An object that authorizes getting the value.
    ...
    """
    return invoke(
        entity, Method.GET, auth, attribute=attribute, instance=instance, 
...
def set_value(entity, value, auth, *, attribute=None, instance=None, 
    ...
    """ 
    invoke(
        entity, Method.SET, auth, attribute=attribute, value=value, 
        instance=instance, index=index, parameter=Argument.VALUE)
...
def clear_value(entity, auth, *, attribute=None, instance=None, index=None):
    ...
    """
    invoke(
        entity, Method.CLEAR, auth, attribute=attribute, instance=instance,
        index=index, parameter=Argument.VALUE)
...
def insert_value(entity, value, auth, *, attribute=None, instance=None, 
    ...
    """ 
    invoke(
        entity, Method.INSERT, auth, parameter=Argument.VALUE, value=value, 
...
def remove_value(entity, auth, *, attribute=None, instance=None, index=None):   
    ...
    """  
    invoke(
        entity, Method.REMOVE, auth, parameter=Argument.VALUE,  
        attribute=attribute, instance=instance, index=index)
...
def replace_value(entity, value, auth, *, attribute=None, instance=None, 
    ...
    """
    invoke(
        entity, Method.REPLACE, auth, parameter=Argument.VALUE, value=value,
        attribute=attribute, instance=instance, index=index)
...
def erase_value(entity, auth, *, attribute=None, instance=None):
    ...
    """ 
    invoke(
        entity, Method.ERASE, auth, parameter=Argument.VALUE, 
        attribute=attribute, instance=instance)

@manage_exceptions(
    'while finding value {1} on {0}', check_for_naked_instance=True)
def find_value(entity, value, auth=None, *, attribute=None, instance=None, 
               index=None): 
    """
    find_value(entity, value, auth=None, *, attribute=None, instance=None, index=None)
    ...
    auth: Authorization or None, optional
        An object that authorizes the find
    ...
    """
    pos = invoke(
        entity, Method.FIND, auth, parameter=Argument.VALUE, value=value,
        attribute=attribute, instance=instance, index=index, 
        return_results=True)
    if pos == 0:
...
def retrieve_value(entity, auth=None, *, attribute=None, instance=None, 
                   index=None, count=None):
    """
    retrieve_value(entity, *, attribute=None, instance=None, index=None, count=None, auth=None)
    ...
    auth: Authorization or None, optional
        An object that authorizes the retrieve
    ...
    return _validate_and_simplify(invoke(
        entity, Method.RETRIEVE, auth, parameter=Argument.VALUE, 
        attribute=attribute, instance=instance, index=index, count=count,
        return_results=True))

@manage_exceptions(
    'while counting values on {0}', check_for_naked_instance=True)
def value_count(entity, auth=None, *, attribute=None, instance=None):
    """
    value_count(entity, *, attribute=None, instance=None, auth=None)
    ...
    auth: Authorization or None, optional
        An object that authorizes the count
    ...
    """
    return invoke(
        entity, Method.COUNT, auth, attribute=attribute, instance=instance,
        return_results=True)
...
def get_label(entity, auth=None, *, attribute=None, instance=None):
    """
    get_label(entity, auth=None, *, attribute=None, instance=None)
    """
    return invoke(
        entity, Method.GET, auth, parameter=Argument.LABEL, attribute=attribute, 
...
def set_label(entity, label, auth, *, attribute=None, instance=None):
    ...
    if isinstance(label, (bytes, bytearray)):
        ...
        invoke(
            entity, Method.SET, auth, parameter=Argument.LABEL, name=label, 
            attribute=attribute, instance=instance)
...
def clear_label(entity, auth, *, attribute=None, instance=None):
    ...
    """
    invoke(
        entity, Method.CLEAR, auth, parameter=Argument.LABEL, 
        attribute=attribute, instance=instance)
...
def erase_label(entity, auth, *, attribute=None):
    ...
    """
    invoke(
        entity, Method.ERASE, auth, parameter=Argument.LABEL, 
        attribute=attribute)

@manage_exceptions('while finding label {2} on entity {0}, attribute {1}')
def find_label(entity, attribute, name, auth=None, *, index=None):
    """
    find_label(entity, attribute, name, auth=None, *, index=None)
    """
    return invoke(
        entity, Method.FIND, auth, parameter=Argument.LABEL, 
        attribute=attribute, name=name, index=index, return_results=True)
...
def get_attribute(entity, attribute, auth=None): 
    """
    get_attribute(entity, attribute, auth=None)
    Return the value of an attribute.
    ...
    auth : Authorization, optional
        an object that authorizes the get
    ...
    """
    return invoke(
        entity, Method.GET, auth, parameter=Argument.ATTRIBUTE, 
...
def set_attribute(entity, attribute, value, auth): 
    ...
    auth : Authorization
        an object that authorizes the set
    ...
    """
    invoke(
        entity, Method.SET, auth, parameter=Argument.ATTRIBUTE, 
...
def clear_attribute(entity, attribute, auth): 
    ...
    auth : Authorization
        an object that authorizes the clear
    ...
    """
    invoke(
        entity, Method.CLEAR, auth, parameter=Argument.ATTRIBUTE, 
        attribute=attribute)
...
def erase_attribute(entity, attribute, auth): 
    ...
    auth : Authorization
        an object that authorizes the create
    ...
    """
    invoke(
        entity, Method.ERASE, auth, parameter=Argument.ATTRIBUTE,
        attribute=attribute)

@manage_exceptions('while finding attribute {1} of entity {0}')
def find_attribute(entity, attribute, auth=None, *, index=None): 
    """
    find_attribute(entity, attribute, auth=None, *, index=None)
    Return the position of ``attribute``, among all the attributes of ``entity``.
    ...
    """
    pos = invoke(
        entity, Method.FIND, auth, parameter=Argument.ATTRIBUTE, 
        attribute=attribute, index=index, return_results=True)
    if pos == 0:
...
def retrieve_attribute(entity, auth=None, *, attribute=None): 
    """
    retrieve_attribute(entity, auth=None, *, attribute=None)
    ...
    attribute : Attribute, optional 
        ...
        If not provided, all attributes of the entity are returned, again
    ...
    """
    return _validate_and_simplify(invoke(
        entity, Method.RETRIEVE, auth, parameter=Argument.ATTRIBUTE, 
        attribute=attribute, return_results=True))

@manage_exceptions('while retrieving attribute of entity {0} at position {1}')
def attribute_item(entity, instance, auth=None):
    """
    attribute_item(entity, instance, auth=None)
    ...
    auth : Authorization, optional
        an object that authorizes the attribute identification
    ...
    return Attribute(invoke(
        entity, Method.ATTRIBUTE, auth, parameter=Argument.ATTRIBUTE,
        instance=instance, return_results=True))

@manage_exceptions('while counting attributes on entity {0}')
def attribute_count(entity, auth=None, *, attribute=None):
    """
    attribute_count(entity, auth=None, *, attribute=None)
    ...
    """ 
    return invoke(
        entity, Method.COUNT, auth, parameter=Argument.ATTRIBUTE, 
        attribute=attribute, return_results=True)
...
def get_property(entity, auth=None, *, key=None, index=None, attribute=None, 
                 instance=None):
    """
    get_property(entity, auth=None, *, key=None, index=None, attribute=None, instance=None)
    ...
    """ 
    return invoke(
        entity, Method.GET, auth, parameter=Argument.PROPERTY, key=key, 
        index=index, attribute=attribute, instance=instance, 
        return_results=True)
...
def set_property(entity, auth, *, name=None, value=None, key=None, 
    ...
    """ 
    invoke(
        entity, Method.SET, auth, parameter=Argument.PROPERTY, name=name, 
        key=key, value=value, attribute=attribute, instance=instance, 
        index=index)
...
def clear_property(entity, auth, *, key=None, index=None, attribute=None, 
    ...
    """
    invoke(
        entity, Method.CLEAR, auth, parameter=Argument.PROPERTY, key=key, 
        index=index, attribute=attribute, instance=instance)
...
def erase_property(entity, auth, *, attribute=None, instance=None):
    ...
    """
    invoke(
        entity, Method.ERASE, auth, parameter=Argument.PROPERTY, 
        attribute=attribute, instance=instance)

@manage_exceptions(
    'while finding property named {1} on entity {0}', 
    check_for_naked_instance=True)
def find_property(entity, name, auth=None, *, attribute=None, instance=None,
                  index=None):
    """
    find_property(entity, name, auth=None, *, attribute=None, instance=None, index=None)
    ...
    """ 
    pos = invoke(
        entity, Method.FIND, auth, attribute=attribute,
...
def retrieve_property(entity, auth=None, *, attribute=None, instance=None, 
                      index=None, count=None):
    """
    retrieve_property(entity, auth=None, *, attribute=None, instance=None, index=None, count=None)
    """
    return _validate_and_simplify(invoke(
        entity, Method.RETRIEVE, auth, parameter=Argument.PROPERTY, 
        attribute=attribute, instance=instance, index=index, count=count,
        return_results=True))

@manage_exceptions(
    'while inserting property on entity {0}', check_for_naked_instance=True)
def insert_property(entity, auth, *, attribute=None, instance=None, 
                    name=None, key=None, value=None, index=None):
    """
    insert_property(entity, auth, *, attribute=None, instance=None, name=None, key=None, value=None, index=None)
    ...
    auth : Authorization
        an object that authorizes the insert
    ...
    """ 
    invoke(
        entity, Method.INSERT, auth, parameter=Argument.PROPERTY,
...
def remove_property(entity, auth, *, attribute=None, instance=None, 
                    key=None, index=None):
    """
    remove_property(entity, auth, *, attribute=None, instance=None, key=None, index=None)
    ...
    auth : Authorization
        an object that authorizes the remove
    ...
    """ 
    invoke(
        entity, Method.REMOVE, auth, parameter=Argument.PROPERTY, 
        attribute=attribute, instance=instance, index=index, 
        key=key)
...
@manage_exceptions(
    ...
    check_for_naked_instance=True)
def replace_property(entity, name, key, value, auth, *, attribute=None, 
                     instance=None, index=None):
    """
    replace_property(entity, name, key, value, auth, *, attribute=None, instance=None, index=None)
    """
    invoke(
        entity, Method.REPLACE, auth, parameter=Argument.PROPERTY, name=name, 
        key=key, value=value, attribute=attribute, instance=instance, 
        index=index)
...
@manage_exceptions(
    ...
    check_for_naked_instance=True)
def update_property(entity, name, value, auth, *, attribute=None, 
                    instance=None, key=None):
    """
    update_property(entity, name, value, auth, *, attribute=None, instance=None, key=None)
    ...
    auth : Authorization
        an object that authorizes the update
    ...
    """ 
    invoke(
        entity, Method.UPDATE, auth, attribute=attribute, instance=instance, 
        name=name, key=key, value=value)

@manage_exceptions(
    'while looking up property with key {1} on entity {0}', 
    check_for_naked_instance=True)
def lookup_property(entity, key, auth=None, *, attribute=None, instance=None):
    """
    lookup_property(entity, key, auth=None, *, attribute=None, instance=None)
    ...
    auth : Authorization, optional
        an object that authorizes the lookup
    ...
    with suppress_console_error_logging('Server reported APPLICATION error'):
        try:
            val = property_value(
                entity, auth, attribute=attribute, instance=instance, key=key,
...
def sort_property(entity, auth, *, attribute=None, instance=None, name=None, 
    ...
    """  
    invoke(
        entity, Method.SORT, auth, attribute=attribute, instance=instance, 
        name=name, key=key, value=value, options=options, timeout=timeout)

@manage_exceptions(
    'while finding name of property on entity {0}', 
    check_for_naked_instance=True)
def property_name(entity, auth=None, *, attribute=None, instance=None, key=None, 
                  index=None):
    """
    property_name(entity, auth=None, *, attribute=None, instance=None, key=None, index=None)
    ...
    auth : Authorization, optional
        an object that authorizes the name access
    ...
    """ 
    return invoke(
        entity, Method.NAME, auth, index=index, attribute=attribute, 
        instance=instance, key=key, return_results=True, results_as_string=True)

@manage_exceptions(
    'while finding key of property on entity {0}', 
    check_for_naked_instance=True)
def property_key(entity, auth=None, *, attribute=None, instance=None, 
                 index=None):
    """
    property_key(entity, auth=None, *, attribute=None, instance=None, index=None)
    ...
    auth : Authorization, optional
        an object that authorizes the key access
    ...
    """ 
    return invoke(
        entity, Method.KEY, auth, index=index, attribute=attribute, 
        instance=instance, return_results=True, results_as_string=True)

@manage_exceptions(
    'while finding value of property on entity {0}', 
    check_for_naked_instance=True)
def property_value(entity, auth=None, *, index=None, attribute=None, 
                   instance=None, key=None):
    """
    property_value(entity, auth=None, *, index=None, attribute=None, instance=None, key=None)
    ...
    auth : Authorization, optional
        an object that authorizes the value access
    ...
    """  
    return invoke(
        entity, Method.VALUE, auth, index=index, attribute=attribute, 
        instance=instance, key=key, return_results=True)

@manage_exceptions(
    'while counting the properties on entity {0}', 
    check_for_naked_instance=True)
def property_count(entity, auth=None, *, attribute=None, instance=None):
    """
    property_count(entity, auth=None, *, attribute=None, instance=None)
...
@manage_exceptions(
    ...
    check_for_naked_instance=True)
def property_member(entity, key, auth=None, *, attribute=None, instance=None): 
    """
    property_member(entity, key, auth=None, *, attribute=None, instance=None)
    """
    try:
        found, ignore = lookup_property(
            entity, key, auth, attribute=attribute, instance=instance, 
            handle_exceptions=False)
        return found
    except at.AvesTerraError as err:
...
def get_annotation(entity, attribute, auth=None, *, key=None, index=None):
    """
    get_annotation(entity, attribute, auth=None, *, key=None, index=None)
    """
    return invoke(
        entity, Method.GET, auth, parameter=Argument.ANNOTATION, 
        attribute=attribute, key=key, index=index, return_results=True)
...
def clear_annotation(entity, attribute, auth, *, key=None, index=None):
    ...
    """ 
    invoke(
        entity, Method.CLEAR, auth, attribute=attribute, key=key, index=index, 
...
def erase_annotation(entity, auth, *, key=None, index=None):
    ...
    """ 
    invoke(
        entity, Method.ERASE, auth, key=key, index=index,
        parameter=Argument.ANNOTATION)

@manage_exceptions('while finding index of annotation {1} on entity {0}')
def find_annotation(entity, attribute, auth=None, *, instance=None, key=None, 
                    index=None):
    """
    find_annotation(entity, attribute, auth=None, *, instance=None, key=None, index=None)
    """
    return invoke(
        entity, Method.FIND, auth, parameter=Argument.ANNOTATION, 
        attribute=attribute, instance=instance, key=key, index=index,
        return_results=True)

@manage_exceptions('while counting annotations on {0}')
def annotation_count(entity, auth=None, *, key=None, index=None):
    """
    annotation_count(entity, auth=None, *, key=None, index=None)
    """
    return invoke(
        entity, Method.COUNT, auth, parameter=Argument.ANNOTATION, key=key, 
        index=index, return_results=True)

@manage_exceptions('while finding annotation at position {1} on entity {0}')
def annotation_item(entity, instance, auth=None, *, key=None, index=None):
    """
    annotation_item(entity, instance, auth=None, *, key=None, index=None)
    """
    return Attribute(invoke(
        entity, Method.ATTRIBUTE, auth, parameter=Argument.ANNOTATION,
...
def method_connected(entity, auth=None, *, method=None, precedence=None):
    """
    method_connected(entity, auth=None, *, method=None, precedence=None)
    """
...
def connection_method(entity, index, auth=None):
    """
    connection_method(entity, index, auth=None)
    """
...
def connection_precedence(entity, index, auth=None):
    """
    connection_precedence(entity, index, auth=None)
    """
    outlet, method, precedence = atapi.connection(
        TranslateFromAvialToAPI.entity(entity),
        index=TranslateFromAvialToAPI.index(index),
...
def connection_outlet(entity, index, auth=None):
    """
    connection_outlet(entity, index, auth=None)
    """
    outlet, method, precedence = atapi.connection(
        TranslateFromAvialToAPI.entity(entity),
        index=TranslateFromAvialToAPI.index(index),
...
def attribute_attached(entity, auth=None, *, attribute=None, precedence=None):
    """
    attribute_attached(entity, auth=None, *, attribute=None, precedence=None)
    """
...
def attachment_attribute(entity, index, auth=None): 
    """
    attachment_attribute(entity, index, auth=None)
    """ 
...
def attachment_precedence(entity, index, auth=None): 
    """
    attachment_precedence(entity, index, auth=None)
    """
    (outlet, attribute, precedence)  = atapi.attachment(
        entity, index=TranslateFromAvialToAPI.index(index),
        authorization=TranslateFromAvialToAPI.authorization(auth))
...
def attachment_outlet(entity, index, auth=None): 
    """
    attachment_outlet(entity, index, auth=None)
    """
...
def wait_event(outlet, auth=None, *, callback=None, timeout=None):
    """
    wait_event(outlet, auth=None, *, callback=None, timeout=None)
    Wait for an event. Then call ``callback``.

    Wait for an event, then call the callback, with 14 arguments.
    If timeout is specified, and the event does not occur within that duration,
    ...
    auth : Authorization or None, optional
        an object authorizing waiting for an event.  
    ...
    *Switch to process 1.* Clean up.
    ...
    return _call_callback_after(
        _wait_event_limited_dur, outlet, callback, timeout, auth,
        f'Waiting on {outlet} with callback {callback}')

def _call_callback_after(after_fn, outlet, callback, timeout, auth, msg):
    """Call after_fn, repeatedly if timeout is None."""
    if timeout:
        logger.debug(msg)
        return after_fn(outlet, callback, timeout, auth)
    else:
        while True:
            try:
                logger.debug(msg)
...
def _wait_event_limited_dur(outlet, callback, timeout, auth):
...
def adapt_outlet(outlet, callback, auth, *, timeout=None):
    """
    adapt_outlet(outlet, callback, auth, *, timeout=None)
    ...
    AvialError
        ...
        or ``auth`` does not authorize the operation, 
    ...
    **value**.
    ...
    >>> while still_active:
    ...     av.adapt_outlet(homemade, echo, auth)
    ...
    _call_callback_after(
        _adapt_outlet_limited_dur, outlet, callback, timeout, auth,
        f'Adapting {outlet} with callback {callback}')

def _adapt_outlet_limited_dur(outlet, callback, timeout, auth):
...
def read_data(entity, auth=None, *, index=None, count=None): 
    """
    read_data(entity, auth=None, *, index=None, count=None)
    """
    return invoke(
        entity, Method.READ, auth, index=index, count=count, 
        return_results=True)
...
def write_data(entity, bytez, auth, *, index=None): 
    ...
    if isinstance(bytez, bytes):
        invoke(
            entity, Method.WRITE, auth, value=bytez, index=index)
    else:
        raise AvialError(
...
def erase_data(entity, auth): 
    ...
    """
    invoke(entity, Method.ERASE, auth)

@manage_exceptions('while determing data size of {0}')
def data_count(entity, auth=None): 
    """
    data_count(entity, auth=None)
    """
    return invoke(
        entity, Method.COUNT, auth, parameter=Argument.DATA, 
        return_results=True)
...
def _initialize_taxonomy():
    ...
    _add_autosave(argument_spec)   # remove when taxonomy updated
...
def _add_autosave(argument_spec):
    """A hack to add AUTOSAVE to the argument spec. Remove on taxonomy update"""
    argument_spec['Properties'].append(['AUTOSAVE_ARGUMENT', 'AUTOSAVE', '1'])
...
class TranslateFromAPItoAvial:
    ...
    def parameter(cls, parameter):
        ...
        return cls._translate(
            parameter, atapi.NULL_PARAMETER, 'parameter', Argument)
...
def trash_entity():           return entity_of("<0|0|6>")
...
def avert_registry():           return entity_of("<0|0|101>")
def aida_registry():            return entity_of("<0|0|102>")
def avian_registry():           return entity_of("<0|0|103>")
